...
(facts "about map-by-key"
  ...
  (facts "function second for tuples"
    (test-hash-node #(spark/make-map-by-key-node (new-id!) [spark-second] [%])
  ...
  (facts "constant function returning 42"
    (test-hash-node #(spark/make-map-by-key-node (new-id!) [spark-constant] [%])
...
(facts "about map"
  ...
  (facts "function second for tuples"
    (test-multiset-node #(spark/make-map-node (new-id!) [spark-second] [%])
  ...
  (facts "constant function returning 42"
    (test-multiset-node #(spark/make-map-node (new-id!) [spark-constant] [%])
